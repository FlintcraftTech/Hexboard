<!-- GENERATED FILE — DO NOT HAND-EDIT.
     Layout: QWERTY (Portuguese) (qwerty-pt), language pt.
     Generated from resources/key-layout-pt.json by scripts/generate-key-manifest.py.
     Edit the JSON and re-run the script; any edit made here will be overwritten. -->

# Key manifest — QWERTY (Portuguese)

This document is a readable view of one Hexboard layout's key inventory: which characters this layout offers, which panel they live on, and where on that panel they sit. The layout is QWERTY (Portuguese), identified as `qwerty-pt`. It is generated from `resources/key-layout-pt.json`, which is the actual source of truth. Edit the JSON, then re-run `scripts/generate-key-manifest.py`.
